...
import "../patient/Helper Components/Modal.css";
import "../patient/Appointments/Appointment.css";
...
const DoctorHome = () => {
  ...
  useEffect(() => {
    axios.get(`/api/appt/doc/all`).then((response) => {
  ...
  const onDeleteConfirmed = () => {
    ...
    if (editingAppt.title === "TeleDoctor Appointment") {
      axios
        .post(`/api/teledoc/delete`, postData, axiosConfig)
        .then((response) => {
            ...
            <div className="changing-word">
              {wordChange === "closing" ? (
                <div className="changing-word-div">
                  <p>{`Patient: ${selectedEvent.patient_name}`}</p>
                ...
                <div>
                  Changing your appointment would delete your current one.
                  Proceed?
                </div>
              ) : (
          ...
          {onConfirm === "null" ? (
            ...
            <div>
              <div className="button-container-edit">
                <button
                  className="headerBtn"
                  onClick={onConfirmedChangeAppointment}
                >
                  Confirm
                </button>
              </div>
