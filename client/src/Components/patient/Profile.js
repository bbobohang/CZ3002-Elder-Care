                        ...
                        <form ref={refInput}>
                            <div className='inputList'>
                                ...
                                <div className='inputItemRight'>
                                    <p>Title</p>
                                    <select className='formDropdown' name="conditions" id="conditions">
                                        <option>Title</option>
                            ...
                            <div className='inputList'>
                                <div className='inputItemLeft'>
                                    ...
                                    <select id="phone" name="phone" className='formDropdown' placeholder='Country/Region Code'>
...
/*
                                    <select className='form' name="conditions" id="conditions" multiple>
                                        <option value="Select">---Select---</option>
                                        <option value="Asthma">Asthma and Respiratory Problems</option>
                                        ...
                                        <option value="Joint">Joint and bone inflammation</option>
                                        <option value="Skin">Skin Conditions</option>
                                        <option value="Mental">Mental Illnesses</option>
