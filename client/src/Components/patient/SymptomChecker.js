				...
				<div className='symptomContainer'>
					<form ref={refInput}>
						...
						<select className='formDropdown' name='symptoms' id='symptoms' multiple>
							...
							<option value=' 46'>
								Burning in the throat</option>


							<option value=' 170'>
								Cheek swelling</option>
							...
							<option value=' 153'>
								Fast, deepened breathing</option>


							<option value=' 76'>
								Feeling of foreign body in the eye</option>
							...
							<option value=' 57'>
								Going black before the eyes</option>
							...
							<option value=' 112'>
								Menstruation disorder</option>


							<option value=' 123'>
								Missed period</option>
							...
							<option value=' 12'>
								Pain in the limbs</option>


							<option value=' 203'>
								Pain on swallowing</option>
							...
							<option value=' 248'>
								Swollen glands in the armpits</option>


							<option value=' 169'>
								Swollen glands on the neck</option>
							...
							<option value=' 115'>
								Tremor at rest</option>


							<option value=' 144'>
								Unconsciousness, short</option>
